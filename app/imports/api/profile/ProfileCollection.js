...
class ProfileCollection extends BaseCollection {
  ...
  define({
    ...
    check({
      firstName, lastName, username, bio, picture, title, location,
    }, checkPattern);
  ...
  dumpOne(docID) {
    ...
    const {
      firstName, lastName, username, bio, interests, picture, title, github, facebook,
      instagram, location,
    } = doc;
    return {
      firstName, lastName, username, bio, interests, picture, title, github, facebook, instagram, location,
    };
  }
}
